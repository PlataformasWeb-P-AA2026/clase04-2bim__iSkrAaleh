...
class EstudianteForm(ModelForm):
    class Meta:
        ...
        labels = {
            ...
            'apellido': _('Ingrese su apellido'),
            'cedula': _('Ingrese su cédula'),
            'correo': _('Ingrese su correo'),
        }
...
class NumeroTelefonicoForm(ModelForm):
    class Meta:
        ...
        labels = {"telefono": ("Ingrese su numero de telefono")}
...
class MensajeForm(ModelForm):
    class Meta:
        model = Mensaje
        fields = ['correo', 'nombres', 'mensaje']
        labels = {
            'correo': _('Ingrese su correo'),
            'nombres': _('Ingrese sus nombres'),
            'mensaje': _('Ingrese su mensaje de salida'),
        }
        widgets = {
